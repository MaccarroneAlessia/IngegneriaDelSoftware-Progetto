...
// la cartella è una classe di supporto che fa da interfaccia al client-> come un Facade
public class Folder {
	...
	// metodi che chiamano i metodi di MyFile e che verranno chiamati dal Client per
	// la ricerca
	public void search() {
